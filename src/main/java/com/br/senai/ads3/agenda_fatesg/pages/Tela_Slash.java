...
public class Tela_Slash extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Tela_Slash.class.getName());
...
//            setAlwaysOnTop(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Tela_Slash().setVisible(true));
    }
